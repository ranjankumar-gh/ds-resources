...
safe_loans_raw = safe_loans_raw[pd.isnull(safe_loans_raw['Gender']) != True]
print len(safe_loans_raw)

safe_loans_raw = safe_loans_raw[pd.isnull(safe_loans_raw['Married']) != True]
print len(safe_loans_raw)

safe_loans_raw = safe_loans_raw[pd.isnull(safe_loans_raw['Education']) != True]
print len(safe_loans_raw)

safe_loans_raw = safe_loans_raw[pd.isnull(safe_loans_raw['Self_Employed']) != True]
print len(safe_loans_raw)
